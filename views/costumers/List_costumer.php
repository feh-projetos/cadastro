...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
              ...
              <div class="row margin=vottom-20">
                <div class="col-md-12 text-right ">
                    <a href="createcostumers.php" title="Novo cadastro" class="btn btn-success"><i class="fa fa-plus-square"></i> Novo </a>
                </div>
              </div>
    </div>
